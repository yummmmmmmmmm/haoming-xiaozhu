import { House, MessagesSquare, Plus, ShoppingBag, User } from 'lucide-react'
import { useLocation, useNavigate } from 'react-router-dom'
import { useApp } from '../store/AppContext'

/** 统一的线性图标规格：1.75px 描边 + 圆头，比 emoji 干净很多 */
const NAV_ICON = { size: 21, strokeWidth: 1.75 } as const
    ...
    <nav className="bottom-nav">
      ...
      <button className="bottom-nav__item" onClick={onQuickRecord}>
        <span className="bottom-nav__center">
          <span className="bottom-nav__center-icon">
